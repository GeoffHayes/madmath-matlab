function varargout = MovePlotGraphic(varargin)
% MOVEPLOTGRAPHIC MATLAB code for MovePlotGraphic.fig
%      MOVEPLOTGRAPHIC, by itself, creates a new MOVEPLOTGRAPHIC or raises the existing
%      singleton*.
%
%      H = MOVEPLOTGRAPHIC returns the handle to a new MOVEPLOTGRAPHIC or the handle to
%      the existing singleton*.
%
%      MOVEPLOTGRAPHIC('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in MOVEPLOTGRAPHIC.M with the given input arguments.
%
%      MOVEPLOTGRAPHIC('Property','Value',...) creates a new MOVEPLOTGRAPHIC or raises the
...
% Last Modified by GUIDE v2.5 29-Jul-2014 21:13:32
